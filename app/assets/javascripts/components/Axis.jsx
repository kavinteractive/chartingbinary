...
const Axis = React.createClass({
    ...
    render() {
        const {height,tickArguments,tickValues,tickDirection,innerTickSize,tickPadding,outerTickSize,scale,orientation,zero} = this.props;
        ...
        return (
            <g className={className} transform={this.translate()} style={{shapeRendering: 'crispEdges'}}>
                {axisBackground}
                {tickElements}
                {pathElement}
                {labelElement}
